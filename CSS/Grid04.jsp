...
<html lang="ko">
  ...
  <body>
    ...
    <div class="container-fluid">	 
    	...
    	<!-- md모드일때만  2번 컨텐츠 보이기-->
    	<div class="row">
    		<div class="col-xs-4">col-xs-4:1번 컨텐츠</div>
    		<div class="col-xs-4 visible-md-block">col-xs-4:2번 컨텐츠</div>
    		<div class="col-xs-4">col-xs-4:3번 컨텐츠</div>    	
    	</div>
    	<h1>반응형 컬럼 초기화 하기</h1>
...
Resize your viewport or check it out on your phone for an example.</div>
    		<div class="col-xs-6 col-sm-3">2번째 컬럼</div>
    		 <!-- 
		  	...
		  	아래 div는 xs모들일때만 나타난다(visible-xs-block때문에)
    	...
    	<h2>응용 문제</h2>
    	<!-- 
			왼쪽에 4칸을 비우고 뒤에 8칸을 차지하는 div만들고
		...
		<div class="row">
			<div class="col-md-offset-4 col-md-8">
				...
				<div class="row">
					<div class="col-md-offset-4 col-md-4">col-md-offset-4 col-md-4</div>
				</div>
			</div>
