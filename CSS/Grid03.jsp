...
<html lang="ko">
  ...
  <body>
    ...
    <div class="container-fluid">	 
    	...
    	<!--  3칸 비우고 첫 div 3칸 그리고 3칸 비우고 두번째 div 3칸으로 배치 -->
    	<div class="row">
		  <div class="col-md-offset-3 col-md-3">.col-md-3 .col-md-offset-3</div>
		  <div class="col-md-offset-3 col-md-3">.col-md-3 .col-md-offset-3</div>
		</div>
		<!-- 3칸 비우고 6칸 배치 ,자동으로 오른쪽 3칸이 비어짐 -->
		<div class="row">
		  <div class="col-md-6 col-md-offset-3">.col-md-6 .col-md-offset-3</div>
		</div>
		<!-- 응용:왼쪽에 2칸 비우고 div하나를 가운데 배치 하기 -->
		<div class="row">
			<div class="col-md-offset-2 col-md-8">응용배치(offset)</div>
		</div>
		...
		pull:지정한 칸수 만큼 왼쪽으로 땡긴다
		 ...
		 <h2>첫번째 div칸,두번째 div 2칸 배치</h2>
		 <div class="row">
		 	<div class="col-md-5">col-md-5</div>
		 	<div class="col-md-2">col-md-2</div>
		 </div>
		 <h3>응용:두번째 div뒤로 첫번째 div보내기</h3>
		 <div class="row">
		 	<div class="col-md-5 col-md-push-7">col-md-5</div>
		 	<div class="col-md-2">col-md-2</div>
		 </div>
		 <h2>offset과 push의 차리</h2>
		 <!-- 
		 	offset:12칸이 넘으면 들어갈 영역이 모자른 경우
			       개행된다
			push :12칸이 넘으면 들어갈 영역이 모자른 경우
			      개행되지 않고 영역밖으로 밀린다.
		  ...
		  <div class="row">
		  	<div class="col-md-2">col-md-2</div>
		  	<div class="col-md-offset-2 col-md-10">col-md-10</div>
		  </div>
		  
		  <div class="row">
		  	<div class="col-md-2">col-md-2</div>
		  	<div class="col-md-push-2 col-md-10">col-md-10</div>
		  </div>
	</div>
