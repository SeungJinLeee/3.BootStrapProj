		...
		<div class="container-fluid">
			...
			<nav id="navbar" class="navbar navbar-default navbar-fixed-top">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<span class="glyphicon glyphicon-education"></span> KOSMO</a>
					</div>
			...
			<div class="scrollspy-content" data-spy="scroll" data-target="#navbar">
				...
				<p>Ad leggings keytar, brunch id art party dolor labore.
					...
					probably haven't heard of them et cardigan trust fund culpa
					biodiesel wes anderson aesthetic. Nihil tattooed accusamus, cred
					irony biodiesel keffiyeh artisan ullamco consequat. ​ Keytar twee
					blog, culpa messenger bag marfa whatever delectus food truck.
					Sapiente synth id assumenda. Locavore sed helvetica cliche irony,
					thundercats you probably haven't heard of them consequat hoodie
					gluten-free lo-fi fap aliquip. Labore elit placeat before they sold
					out, terry richardson proident brunch nesciunt quis cosby sweater
