  ...
  <body>
  	<div class="container">
  		<div class="page-header">
    		<h1>모달(Modals)<small>modal.js</small></h1>
    	</div>
    	<h2>모달 띄우기 기본</h2>
    	<button class="btn btn-success" data-toggle="modal" data-target="#basic-modal"><img src="../Images/summer.jpg"/></button>
    	<!-- 모달창 시작 -->
    	...
    	<button class="btn btn-success" id="btnModal">자바스크립트</button>
